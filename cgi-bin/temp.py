...
print('<a href="#"><li>BLOGS</li></a>')
print('<a href="#"><li>FEATURES</li></a>')
print(' </ul>')
print('</div>')
...
print('</br><span>When will my Flipkart account be updated with the new email address (or mobile number)?</span></br>')
print('It happens as soon as you confirm the verification code sent to your email (or mobile) and save the changes.')
print('</br><span>What happens to my existing Flipkart account when I update my email address (or mobile number)?</span></br>')
...
print("Flipkart has a 'single sign-on' policy. Any changes will reflect in your Seller account also.")
print('</div></br></br>')
print('<p style="font-family:sans-serif;color:red;cursor:pointer;">Deactivate Account</p>')

#--------------------footer--------------------
print('<h2 class="footer_head">On the Gram</h2>')
print('<div id="footer">')
print('<ul style="list-style-type:none">')
...
print('<a href="#"><li>Cart</li></a>')
print('<a href="#"><li>Wishlist</li></a>')
print('<a href="#"><li>Product Compare</li></a>')
print('</ul>')
print('<ul style="list-style-type:none">')
